  ...
  resolveWebviewView(
    ...
    setInterval(() => {
      ...
      if (errors < 18) {
        ...
        webviewView.webview.html = this.getHtmlContent(webviewView.webview, 18);
      }
    }, 1000);
  }

  private getHtmlContent(webview: vscode.Webview, error: number): string {
